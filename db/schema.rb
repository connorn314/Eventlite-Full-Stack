...
ActiveRecord::Schema[7.0].define(version: 2022_12_12_012058) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.bigint "tickets_allotted", null: false
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id", "liker_id"], name: "index_likes_on_event_id_and_liker_id", unique: true
  end
